...
if ($searchValue -eq "*") {
    ...
    $filter = "Enabled -eq `$False -and (Name -like '*$searchValue*' -or DisplayName -like '*$searchValue*' -or userPrincipalName -like '*$searchValue*' -or mail -like '*$searchValue*')"
}
